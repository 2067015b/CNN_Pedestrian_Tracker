...
def occlude_boxes(input_dir, output_dir):
    all_detections = open("{}\\allD.txt".format(input_dir), 'r')

    for line in all_detections:
        line = line.split()
        try:
            img = misc.imread("{}/temp/ovalidation_1_{}.jpg".format(input_dir, line[0]))
        except:
            img = misc.imread("{}/images/ovalidation_1_{}.jpg".format(input_dir, line[0]))
        ...
        misc.imsave("{}/temp/ovalidation_1_{}.jpg".format(input_dir, line[0]), img)
...
def overlaps(detection, occlusion):
    ...
    return [x_1d, y_1d, x_2d - x_1d, y_2d - y_1d]
...
if __name__ == "__main__":
    ...
    occlude_all("data/green/validation_1/images/", "data/green/validation_1/occluded/",
                "data/green/validation_1/allD.txt")
